...
<li class="text" id="licontainer_<?php echo $result_str; ?>">
    <div class="title title<?php echo $result_str; ?> gt-fieldset"
         title="<?php _e('Double Click to toggle and drag-drop to sort', GEODIRECTORY_TEXTDOMAIN); ?>"
        ...
        <?php else: ?>
            <div title="<?php _e('Click to remove field', GEODIRECTORY_TEXTDOMAIN); ?>"
        ...
        if ($field_type == 'fieldset') {
            ...
            <b style="cursor:pointer;"
               onclick="show_hide('field_frm<?php echo $result_str;?>')"><?php echo ucwords(__('Fieldset:', GEODIRECTORY_TEXTDOMAIN) . ' ' . $field_admin_title);?></b>
        <?php
        } else {
            ?>
            <b style="cursor:pointer;"
               onclick="show_hide('field_frm<?php echo $result_str;?>')"><?php echo ucwords(__('Field:', GEODIRECTORY_TEXTDOMAIN) . ' ' . $field_admin_title . ' (' . $field_type . ')');?></b>
        <?php
        }
        ?>
    </div>
        ...
        <table class="widefat post fixed" border="0" style="width:100%;">
            ...
            <?php } else { ?>
                ...
                <tr class="decimal-point-wrapper"
                    ...
                    <td width="30%"><strong><?php _e('Select decimal point :', GEODIRECTORY_TEXTDOMAIN); ?></strong>
                    </td>
                    <td align="left">
            ...
            <?php if ($field_type != 'fieldset' && $field_type != 'taxonomy') {
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <br/>
                        <span><?php _e('HTML variable name not use spaces, special characters', GEODIRECTORY_TEXTDOMAIN);?></span>
                    </td>
                </tr>
            <?php } ?>
            <tr>
                ...
                <td align="left">
                    <select name="is_default" id="is_default">
                        <option value="0" <?php if (!isset($field_info->is_default) || $field_info->is_default == '0') {
                            echo 'selected="selected"';
                        } ?>><?php _e('No', GEODIRECTORY_TEXTDOMAIN); ?></option>
                        <option value="1" <?php if (isset($field_info->is_default) && $field_info->is_default == '1') {
                            echo 'selected="selected"';
                        } ?>><?php _e('Yes', GEODIRECTORY_TEXTDOMAIN); ?></option>
                    </select>
                    <br/>
                    <span><?php _e('Select yes or no. If no is selected then the field will be displayed as main form field or additional field', GEODIRECTORY_TEXTDOMAIN); ?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <br/>
                    <span><?php _e('Select yes or no. If no is selected then the field will not be displayed anywhere', GEODIRECTORY_TEXTDOMAIN); ?></span>
                </td>
            </tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <select name="for_admin_use" id="for_admin_use">
                            <option
                                value="1" <?php echo($for_admin_use ? 'selected="selected"' : ''); ?>><?php _e('Yes', GEODIRECTORY_TEXTDOMAIN); ?></option>
                            <option
                                value="0" <?php echo(!$for_admin_use ? 'selected="selected"' : ''); ?>><?php _e('No', GEODIRECTORY_TEXTDOMAIN); ?></option>
                        </select>
            ...
            <tr>
                <td><strong><?php _e('Show in More Info tab on detail page? :', GEODIRECTORY_TEXTDOMAIN); ?></strong>
                </td>
                <td align="left">
                    ...
                    <br/>
                    <span><?php _e('Want to show this in More Info tab on detail page?', GEODIRECTORY_TEXTDOMAIN); ?></span>
                </td>
            </tr>
                ...
                case 'taxonomy': {
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <br/>
                            <span><?php _e('Selected taxonomy name use as field name index. ex:-( post_category[gd_placecategory] )', GEODIRECTORY_TEXTDOMAIN);?></span>
                        </td>
                    </tr>
                        ...
                        <td align="left">
                            ...
                            <select name="cat_display_type" id="cat_display_type">
                                <option <?php if (isset($field_info->extra_fields) && unserialize($field_info->extra_fields) == 'ajax_chained') {
                                    echo 'selected="selected"';
                                }?> value="ajax_chained"><?php _e('Ajax Chained', GEODIRECTORY_TEXTDOMAIN);?></option>
                                <option <?php if (isset($field_info->extra_fields) && unserialize($field_info->extra_fields) == 'select') {
                                    echo 'selected="selected"';
                                }?> value="select"><?php _e('Select', GEODIRECTORY_TEXTDOMAIN);?></option>
                                <option <?php if (isset($field_info->extra_fields) && unserialize($field_info->extra_fields) == 'multiselect') {
                                    echo 'selected="selected"';
                                }?> value="multiselect"><?php _e('Multiselect', GEODIRECTORY_TEXTDOMAIN);?></option>
                                <option <?php if (isset($field_info->extra_fields) && unserialize($field_info->extra_fields) == 'checkbox') {
                                    echo 'selected="selected"';
                                }?> value="checkbox"><?php _e('Checkbox', GEODIRECTORY_TEXTDOMAIN);?></option>
                                <option <?php if (isset($field_info->extra_fields) && unserialize($field_info->extra_fields) == 'radio') {
                                    echo 'selected="selected"';
                                }?> value="radio"><?php _e('Radio', GEODIRECTORY_TEXTDOMAIN);?></option>
                            </select>

                            <br/>
                            <span><?php _e('Show categories list as select,multiselect,checkbox or radio', GEODIRECTORY_TEXTDOMAIN);?></span>
                        </td>
                    </tr>
                ...
                case 'radio' : {
                    if ($field_type == 'multiselect') {
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <br/>
                                <span><?php _e('Show multiselect list as multiselect,checkbox or radio', GEODIRECTORY_TEXTDOMAIN);?></span>
                            </td>
                        </tr>
                    <?php
                    }
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <br/>
                            <span><?php _e('If using for a "tick filter" place a / and then either a 1 for true or 0 for false', GEODIRECTORY_TEXTDOMAIN);?></span>
                            <br/>
                            <span><?php _e('eg: "No Dogs Allowed/0,Dogs Allowed/1" (Select only, not multiselect)', GEODIRECTORY_TEXTDOMAIN);?></span>
                            <?php if ($field_type == 'multiselect' || $field_type == 'select') { ?>
                                <br/>
                                <span><?php _e('- If using OPTGROUP tag to grouping options, use "{optgroup}OPTGROUP-LABEL|OPTION-1,OPTION-2{/optgroup}"', GEODIRECTORY_TEXTDOMAIN); ?></span>
                                <br/>
                                <span><?php _e('eg: "{optgroup}Pets Allowed|No Dogs Allowed/0,Dogs Allowed/1{/optgroup},{optgroup}Sports|Cricket/Cricket,Football/Football,Hockey{/optgroup}"', GEODIRECTORY_TEXTDOMAIN); ?></span>
                            <?php } ?>
                        </td>
                    </tr>
                <?php
